...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private static final int DEFAULT_LINECOLOR = 0xeee4e4e7;
    private static final int DEFAULT_GRIDCOLOR = 0x00ffffff;
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (textColor == null)
            textColor = ColorStateList.valueOf(getResources().getColor(R.color.holo_gray_light));
        int textSize = ta.getDimensionPixelSize(R.styleable.gridPasswordView_textSize, -1);
        if (textSize != -1) {
            this.textSize = px2sp(context, textSize);
        }

        lineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_lineWidth, dp2px(getContext(), 1));
        lineColor = ta.getColor(R.styleable.gridPasswordView_lineColor, DEFAULT_LINECOLOR);
        gridColor = ta.getColor(R.styleable.gridPasswordView_gridColor, getResources().getColor(R.color.color_white));
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.widet_gridpasswordview, this);
        ...
        while (index < passwordLength) {
            View dividerView = inflater.inflate(R.layout.widet_gridpasswordview_divider, null);
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.widet_gridpasswordview_textview, null);
